 ...
 * An interview is considered unique by comparing using {@code Interview#isSameInterview(Interview)}. As such, adding
 * and updating of interviews uses {@code Interview#isSameInterview(Interview)} for equality so as to ensure that the
 * interview being added or updated is unique in terms of identity in the UniqueInterviewList. However, the removal of
 * an interview uses Interview#equals(Object) so as to ensure that the interview with exactly the same fields will be
 * removed.
 * <p>
